...
import { AlbumCardComponent } from './component/album-list/album-tiles/album-card/album-card.component';
import { AlbumListComponent } from './component/album-list/album-list.component';
import { AlbumSquareComponent } from './component/album-list/album-tiles/album-square/album-square.component';
import { AlbumRowComponent } from './component/album-list/album-tiles/album-row/album-row.component';
