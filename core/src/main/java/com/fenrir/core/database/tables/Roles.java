...
import com.fenrir.core.database.tables.records.RolesRecord;
...
public class Roles extends TableImpl<RolesRecord> {
     ...
     */
    public final TableField<RolesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(20).nullable(false), this, "");
    ...
    public UniqueKey<RolesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(Roles.ROLES, DSL.name("pk_roles"), new TableField[] { Roles.ROLES.ID }, true);
    }

    @Override
    public List<UniqueKey<RolesRecord>> getUniqueKeys() {
        return Arrays.asList(
            Internal.createUniqueKey(Roles.ROLES, DSL.name("uq_roles_name"), new TableField[] { Roles.ROLES.NAME }, true)
        );
    }
